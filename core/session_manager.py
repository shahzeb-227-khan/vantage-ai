"""
core/session_manager.py — Local JSON session storage for Vantage.

Tracks per-session confidence metrics, persists summaries to
``data/history.json``, and generates rule-based improvement tips.
